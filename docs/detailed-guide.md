# WhatsApp Web Plus detailed guide

[Back to the installation guide](../README.md). Use this reference for additional features, installation methods, and developer notes.
...
- **Participant list separator** tells the script how names are separated in group participant lists. This lets long lists be split and shortened correctly in activity announcements. Enter only the separator, without surrounding names or spaces. Example: **semicolon**.
